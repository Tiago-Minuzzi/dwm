...
static const char *fonts[]          = { "JetBrains Mono:style=Bold:size=10", "Font Awesome 6 Free Solid:size=10", "JoyPixels:style=Regular:size=10" };
...
static const char *rofi[]       = { "rofi", "-modi", "drun", "-show", "drun", "-show-icons", "-display-drun", "", "-disable-history", NULL};
static const char *screenlock[] = { "bash", ".local/bin/lockscreen.sh", NULL };
static const char *suslock[]    = { "systemctl", "suspend", NULL };
...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_z,      spawn,          {.v = screenlock } },
