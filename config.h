...
static const Rule rules[] = {
    ...
    {"Firefox", NULL, NULL, 0, 0, -1}, {"Zotero", "Toplevel", NULL, 0, 1, -1},
    {"feh", "feh", NULL, 0, 1, -1},    {"Pavucontrol", NULL, NULL, 0, 1, -1},
...
static const Key keys[] = {
    ...
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3)
        TAGKEYS(XK_5, 4) TAGKEYS(XK_6, 5) TAGKEYS(XK_7, 6) TAGKEYS(XK_8, 7)
            TAGKEYS(XK_9, 8){MODKEY | ControlMask | ShiftMask, XK_e, quit, {0}},
    {MODKEY | ControlMask | ShiftMask, XK_q, quit, {1}}, // reload dwm
