...
sudo pacman -S --needed alacritty brightnessctl feh libxft playerctl network-manager-applet polkit-kde-agent ranger sxhkd ttf-font-awesome ttf-jetbrains-mono ttf-joypixels ueberzug unclutter xorg-server xorg-setxkbmap xorg-xinit xorg-xrandr && \
